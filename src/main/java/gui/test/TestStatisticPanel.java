...
import gui.statistic.PlayerTableModel_Advanced;
import gui.statistic.PlayerTableModel_Basic;
...
import newgui.WhitePanel;

import businessLogicService.playersBLService.PlayersBLService_new;
import vo.PlayerAdvancedStatsVO;
import vo.PlayerBasicStatsVO;

public class TestStatisticPanel extends WhitePanel implements PlayerSearch{
	...
	public TestStatisticPanel() {
		...
		//tbl_basicList.setHorizontalScrollEnabled(true);
		//tbl_basicList.packAll();
		...
		/*tbl_basicList.setSortOrder("姓名", SortOrder.ASCENDING);
		...
		//tbl_basicList.setHighlighters(simpleStriping, magenta);
	...
	public void getList(Conference c, Division d, Position p) {
		try {
			basicList_average = playerService.getBasicPlayersStatsAverage("13-14",c,d,p);
			basicList_total = playerService.getBasicPlayersStatsTotal("13-14",c,d,p);
		} catch (PlayerNotFound e) {
			basicList_average = new ArrayList<PlayerBasicStatsVO>();
			basicList_total = new ArrayList<PlayerBasicStatsVO>();
		}
		try {
			advancedList_average = playerService.getAdvancedPlayersStatsAverage("13-14",c,d,p);
			advancedList_total = playerService.getAdvancedPlayersStatsTotal("13-14",c,d,p);
		} catch (PlayerNotFound e) {
