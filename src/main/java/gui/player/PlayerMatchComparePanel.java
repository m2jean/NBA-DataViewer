...
public class PlayerMatchComparePanel extends PlayerStatsPanel implements MatchChangeable{
	...
	public PlayerMatchComparePanel(PlayersBLService_new playerService,String name) {
		this(playerService,name,Terminology.getPlayerMatchBasic(),15,new Insets(2,5,2,5),new Insets(5,5,5,5));
	}
	public PlayerMatchComparePanel(PlayersBLService_new playerService,String name,Terminology[] term_basic
