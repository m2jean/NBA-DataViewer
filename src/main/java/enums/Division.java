...
public enum Division {
	...
	static public Division[] getWesternDivision(){
		return new Division[]{NATIONAL, NORTHWEST, PACIFIC, SOUTHWEST};
	}
	static public Division[] getDivision(){
		return new Division[]{ATLANTIC, CENTRAL, SOUTHEAST, NORTHWEST, PACIFIC, SOUTHWEST};
	}
}
